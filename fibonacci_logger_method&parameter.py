...
@author: Desye Melese @Addis Ababa university 

'''
#task  name complexity project
# task1 : Add a logger method to the complexity project and Add a parameter using parseargs that sets nmax
